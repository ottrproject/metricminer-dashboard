...
You can take a look at the [`metricminer` R package documentation](https://ottrproject.org/metricminer/articles/getting-started.html) for more details about the functions and what is possible.

If you have a metric need that is not currently fulfilled by `metricminer` or `metricminer-dashboard` we encourage you to [file a GitHub issue with us and let us know about your new feature idea (or bug report)](https://github.com/ottrproject/metricminer/issues/new/choose).
